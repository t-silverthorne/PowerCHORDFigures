...
getNonConvexQC = function(Nfine,A11,A12,A22){
  ...
  QC[[6]] = list(Qc=Qp3sp,q=toSparseVector(qp3sp),rhs=0,sense='=')
  ...
  QC[[7]] = list(Qc=Qp4sp,q=toSparseVector(qp4sp),rhs=0,sense='=')
  ...
  QC[[8]] = list(Qc=Qp5sp,q=toSparseVector(qp5sp),rhs=0,sense='=')
  ...
  QC[[9]] = list(Qc=Qp6sp,q=toSparseVector(qp6sp),rhs=0,sense='=')
  
  Qp7      = sparseMatrix(ip7,ip6,x=1,dims=c(np,np))
  Qp7sp    = bdiag(Matrix(rep(0,n*n),nrow=n),Qp7)
  QC[[10]] = list(Qc=Qp7sp,q=0,rhs=1,sense='=')
