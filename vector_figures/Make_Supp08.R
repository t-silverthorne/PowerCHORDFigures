...
df1 = read.csv('additional_figures/data/compTimes_varyPerm_methodtictoc_alt.csv',header=F)
...
df2 = read.csv("additional_figures/data/compTimes_methodtictoc_Ns1000_Np1000_2.csv",header=F)
...
ggsave(
  filename = "vector_figures/SuppFig08.pdf",
  plot = Fig,
  device = "pdf",
  width = 6,
  height = 4,
