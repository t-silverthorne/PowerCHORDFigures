...
# ---------------------------------------------
dfa  = read.csv('MATLAB/other/pr_relic/figs_relic/data/results_prF1a_equi_1.csv',header=F)
dfa2 = read.csv('MATLAB/other/pr_relic/figs_relic/data/results_prF1a_equi_2.csv',header=F)
dfa3 = read.csv('MATLAB/other/pr_relic/figs_relic/data/results_prF1a_equi_3.csv',header=F)
