...
void Input() {
    ...
    printf("  -------------                            -------------\n");
    printf("  1.  Unrestricted                         21. Unrestricted \n");
    printf("  2.  Fixed-density                        22. Fixed-density\n");
    printf("  3.  Fixed-content necklaces              23. Fixed-conent necklaces\n");
    printf("  4.  Forbidden substring                  24. Forbidden substring \n");
    printf("  5.  Bracelets                            25. Bracelets \n");
    printf("  6.  Fixed-content bracelets              26. Fixed-content bracelets \n");
    printf("  7.  Unlabeled (binary)                   27. Unlabeled (binary) \n");
    printf("  \n");
    printf("  8.  Charm bracelets \n");
    printf("  9.  Fixed-content charm bracelets \n");
    printf("  10. Chord diagrams \n");
    printf("  11. Lyndon brackets (basis for n-th homogeneous component of free Lie algebra)\n");
    printf("  12. De Bruijn cycle\n");
